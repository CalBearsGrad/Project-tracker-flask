...
ings in your hackbright_web.py:

On the function declaration for the student-adding method, you’ll need to specify that this route should accept POST requests. For security reasons, Flask requires that you say this specifically, rather than assuming that all
--
